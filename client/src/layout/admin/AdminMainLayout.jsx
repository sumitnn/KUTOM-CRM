              ...
              <div className="mb-8">
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-sm border border-white/60">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-3 h-2 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full animate-pulse"></div>
                        <h2 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
                          Welcome back, {user?.username || 'Admin'}!
                        </h2>
                      </div>
                      <p className="text-slate-600 text-lg">
                        {user?.role ? `${user.role.charAt(0).toUpperCase() + user.role.slice(1)} Dashboard` : 'Dashboard Overview'}
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3 mt-4 lg:mt-0">
                      ...
                      <div className="hidden xl:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-200">
                        <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                        <span className="text-sm font-semibold text-blue-700">Online</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <div className="h-1.5 w-32 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full shadow-lg shadow-blue-500/25"></div>
                ...
                <div className="bg-gradient-to-r from-white to-slate-50/80 border-b border-slate-200/60 px-6 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-slate-500">
                      {expanded ? "Minimized Workspace" : "Maximized Workspace"}
                    </div>
                  </div>
                </div>
              ...
              <footer className="mt-8 w-full">
                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-white/40 text-center w-full">
                  <p className="text-slate-600 text-sm">
                    © {new Date().getFullYear()} {user?.role ? `${user.role.charAt(0).toUpperCase() + user.role.slice(1)}` : 'Admin'} Portal • 
                    <span className="text-blue-600 font-medium ml-1">All rights reserved to Stocktn</span>
                  </p>
                </div>
              </footer>
            </div>
