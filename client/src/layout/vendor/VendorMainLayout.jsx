              ...
              {!isMobileSidebarOpen && (
                <div className="lg:hidden mb-4">
                  <button
                    ...
                    className="w-full bg-gradient-to-r cursor-pointer from-orange-500 to-amber-500 hover:from-amber-600 hover:to-orange-600 text-white py-3 px-4 rounded-xl font-medium flex items-center justify-center gap-2 transition-all duration-200 shadow-lg shadow-orange-500/25 hover:shadow-orange-600/25"
                  >
                ...
                <div className="bg-gradient-to-r from-white to-slate-50/80 border-b border-slate-200/60 px-4 md:px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-amber-500 rounded-lg flex items-center justify-center shadow-sm">
                    ...
                    <div className="hidden lg:flex items-center gap-2 text-sm text-slate-500 bg-white/50 rounded-full px-3 py-1 border border-slate-200/60">
                      <div className={`w-2 h-2 rounded-full ${expanded ? 'bg-green-500' : 'bg-orange-500'}`}></div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div className="text-center md:text-left">
                      <p className="text-slate-600 text-sm">
                        © {new Date().getFullYear()} Vendor Portal • 
