...
const EditSectionModal = ({ 
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[calc(100vh-40px)] overflow-y-auto transform transition-all duration-300 ease-in-out mt-5">
