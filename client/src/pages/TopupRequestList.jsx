        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="inline-flex items-center cursor-pointer px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                      ...
                      <tr key={request.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <button
                            ...
                            className="text-blue-600 hover:text-red-900 flex items-center justify-end w-full cursor-pointer"
                          >
