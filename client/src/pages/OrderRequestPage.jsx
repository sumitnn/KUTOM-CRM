...
const OrderRequestPage = ({ role }) => {
  ...
  const renderStockistDetails = (requestedBy) => {
  ...
  const handleViewDetails = (requestId) => {
    const path = role === "stockist" ? `/stockist/order-requests-details/${requestId}` : `/order-requests-details/${requestId}`;
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {role === 'admin' ? 'Manage all order requests' : 'View your order requests'}
          </p>
        </div>
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <label className="label">
                <span className="label-text font-medium">Search by Stockist Email</span>
              </label>
              <div className="join w-full">
                <input
                  type="email"
                  placeholder="Enter stockist email..."
                  value={searchEmail}
