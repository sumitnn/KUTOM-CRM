          ...
          <div className="w-full md:w-1/2 px-4">
              ...
              <div className="flex space-x-2">
                {colors.map((color, i) => (
                  <button
                    ...
                    style={{ backgroundColor: color.includes("-") ? undefined : color }}
                    onClick={() => setSelectedColor(color)}
                  >
                    {/* For tailwind colors like gray-300 and blue-500, use bg class */}
                    <span
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-16 text-center rounded-md border border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              />
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>Quick charge: 10 mins = 5 hours playback</li>
              </ul>
            </div>
          </div>
        </div>
