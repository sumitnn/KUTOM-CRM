...
const EditAnnouncementModal = ({ open, onClose, announcement }) => {
  const [updateAnnouncement, { isLoading, error }] = useUpdateAnnouncementMutation();
  ...
  useEffect(() => {
    if (announcement) {
      setFormData({
        ...
        visible_to: announcement.visible_to || 'all',
